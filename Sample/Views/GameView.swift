    ...
    var body: some View {
        ZStack {
            VStack(alignment: .center) {
                // Opponent - 🪨 📄 ✂️
                Image(systemName: opponentMove.description)
                    .resizable()
                    .scaledToFit()
                    .frame(width: 100)
                    .padding(.top)
                ...
                // Player - Move
                Image(systemName: currentMove.description)
                    .resizable()
                    .scaledToFit()
                    .frame(width: 100)
                    .padding()
